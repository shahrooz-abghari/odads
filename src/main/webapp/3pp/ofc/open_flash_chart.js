...
function ofc_pie() {
        ...
        /*
         * index: the index of the series to use
         * gradient: {
         *              colour (String, required): The color for this gradient entry,
         *              alpha (0-1, default 1): The alpha value for this entry in the gradient.
         *              ratio (0-1, default -1 to distribute automatically): Where in the graphical element to start the transition
         *                              to the associated color. Flex uniformly spaces any GradientEntries with missing ratio values.
         * }
         */
        this.add_gradient = function(index, gradient) {
                if (!this.gradients) {
                        this.gradients = [];
                }
                ...
                gradient.alpha = typeof gradient.alpha === 'undefined'? 1 : gradient.alpha;
                gradient.ratio = typeof gradient.ratio === 'undefined'? -1 : gradient.ratio;
                this.gradients[index].push(gradient);
        };
