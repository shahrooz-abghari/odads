package com.bth.anomalydetection.ajax.json;
...
public class ConversionServiceAwareObjectMapper extends ObjectMapper {
	...
	public ConversionServiceAwareObjectMapper(ConversionService conversionService) {
		...
		SerializationConfig sconfig = new SerializationConfig(DEFAULT_INTROSPECTOR, introspector,  VisibilityChecker.Std.defaultInstance());
		DeserializationConfig dconfig = new DeserializationConfig(DEFAULT_INTROSPECTOR, introspector,  VisibilityChecker.Std.defaultInstance());
